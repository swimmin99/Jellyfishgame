...
public class prototypeStageController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        leftWall.transform.position = new Vector3(-1 * movingLimitX, 0, localScaleZ);
        leftWall.transform.localScale = new Vector3(0.5f, 15, 15);


        GameObject rightWall = Instantiate(wallPrefab, gameObject.transform);
        rightWall.transform.position = new Vector3(movingLimitX, 0, localScaleZ);
        ...
        waterLine.transform.position = new Vector3(0, movingLimitY * 0.9f, localScaleZ);
        ceiling.transform.localScale = new Vector3(15, 1, 15);
